...
public interface ApplicationHandleHistoryRepository
		extends JpaRepository<ApplicationHandleHistory, Long> {
	...
	Page<ApplicationHandleHistory> findByStatusAndCreateDateBetween(Status status, Date start, Date end, Pageable pageable);

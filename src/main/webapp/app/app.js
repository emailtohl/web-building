 ...
 */
define([ 'angular', 'uirouter', 'common/context', 'test/context', 'auth/context', 'dashboard/context' ],
	function(angular) {
		return angular.module('appdemo', [ 'ui.router', 'commonModule', 'testModule', 'authModule', 'dashboardModule' ])
